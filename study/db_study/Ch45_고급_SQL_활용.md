...
뭔가 몇 년 전에 개발자들이 JPA의 도입을 반대한 이유를 알 것 같다. ㅋㅋㅋㅋ

진짜 이렇게나 복잡한 DB와 쿼리의 세상이 있는데, 이걸 네이티브 쿼리로 직접 쓰는 것도 아니고 JPA로 변환해서 사용하려면 얼마나 복잡할지 상상이 안된다.

근데 또 현업에 무사히 정착한 것을 보니 진짜 규모가 큰 서비스에서도 내가 생각하는 정도의 심각한 JPA 세팅을 할 필요는 없었나보다.

아무튼 이번 장은 대충 내용의 의도는 잘 이해했지만 역시 내가 할 수 있는 영역은 아니었던 것 같다.ㅋㅋㅋ 그냥 그렇구나 하고 넘어갔다.